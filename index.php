...
<div class="jumbotron jumbotron-fluid ">
    <div class="container text-center">
        <h1 class="display-4">Support a Noble Cause</h1>
        <p class="lead">Join us in making a positive impact on lives through your generous donations.</p>
        <a href="login.php" class="btn btn-primary btn-lg">Donate Now</a>
    </div>
</div>
    ...
    if (isset($stories_result)) {
        if (mysqli_num_rows($stories_result) > 0) {
            ...
            while ($story = mysqli_fetch_assoc($stories_result)) {
                ...
                echo '<a href="login.php" class="btn btn-primary">See Details</a>';
                echo '</div>';
                echo '</div>';
                echo '</div>';
            }
...
<footer class="mt-5 py-3 bg-light">
    <div class="container text-center">
        <p>&copy; 2023 BdHelp. All rights reserved.</p>
    </div>
</footer>
