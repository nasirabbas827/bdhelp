<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item ">
        <a class="nav-link" href="manage_stories.php">Manage Stories</a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" href="manage_agreement.php">Manage Aggreement Status</a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" href="all_donations.php">View All Donations</a>
      </li>
      <li class="nav-item ">
