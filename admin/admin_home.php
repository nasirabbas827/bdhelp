...
$totalstories = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) AS total FROM stories"))['total'];
$totalPendingstories = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) AS total FROM stories WHERE status = 'pending'"))['total'];
...
<div class="container mt-5">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text"><?php echo $totalstories; ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row mt-4">
        ...
        <!-- Total Pending Stories Card -->
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Total Pending Stories</h5>
                    <p class="card-text"><?php echo $totalPendingstories; ?></p>
                </div>
            </div>
        </div>
