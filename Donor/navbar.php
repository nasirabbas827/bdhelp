<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="donor_dashboard.php">Donor Dashboard</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            if (isset($_SESSION["user_id"]) && !empty($_SESSION["user_id"])) {
                echo '<li class="nav-item"><a class="nav-link" href="donor_dashboard.php">Home</a></li>';
                echo '<li class="nav-item"><a class="nav-link" href="update_profile.php">Update Profile</a></li>';
                echo '<li class="nav-item"><a class="nav-link" href="stories_request.php">My Requests</a></li>';
