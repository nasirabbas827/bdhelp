<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="beneficiary_dashboard.php">Beneficiary Dashboard</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            if (isset($_SESSION["user_id"]) && !empty($_SESSION["user_id"])) {
                echo '<li class="nav-item"><a class="nav-link" href="beneficiary_dashboard.php">Home</a></li>';
                echo '<li class="nav-item"><a class="nav-link" href="update_profile.php">Update Profile</a></li>';
                echo '<li class="nav-item"><a class="nav-link" href="story_status.php">My Story Status</a></li>';
                echo '<li class="nav-item"><a class="nav-link" href="all_donations.php">View All Donations</a></li>';
